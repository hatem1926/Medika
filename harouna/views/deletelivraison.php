...
if(!empty($_GET['id']))
  { $id=$_REQUEST['id']; } 
if(!empty($_POST))
  { $id= $_POST['id']; $pdo=Database::connect(); $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
     $sql = "DELETE FROM livraison  WHERE id = ?";
        $q = $pdo->prepare($sql);
        $q->execute(array($id));
        Database::disconnect();
        header("Location: livraisoon.php");
...
<br />
<form class="form-horizontal" action="deletelivreur.php" method="post">
...
<div class="form-actions">
                          ...
                          <a class="btn" href="livraison.php">No</a>
</div>
<p>
