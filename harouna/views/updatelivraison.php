...
{ header("Location: livraison.php"); }
 ...
 if ($valid) { 
    ...
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                ...
                $sql = "UPDATE livraison SET name = ?,tel = ?, email = ?, region = ?, etat = ? WHERE id = ?";
                $q = $pdo->prepare($sql);
                $q->execute(array($name, $tel, $email,$region, $etat, $id));
                Database::disconnect();
                header("Location: livraison.php");
            } 
           }else {
...
<br />
<form method="post" action="updatelivraison.php?id=<?php echo $id ;?>">
