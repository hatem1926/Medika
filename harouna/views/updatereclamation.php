...
<br />
<div class="controls">
                        livreur : <input type="checkbox" name="type" value="livreur" <?php if (isset($type) && $type == "livre") echo "checked"; ?>>
                        encours <input type="checkbox" name="type" value="livraison" <?php if (isset($type) && $type == "encours") echo "checked"; ?>>
