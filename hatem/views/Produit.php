...
<?PHP }
													?>
														<form class="form-horizontal" name="formR" method="POST" action="ajouter_ldc" onclick="return confirmation();">
													<input type="hidden" name="nomproduit" value="<?PHP echo $row['nomproduit'] ?>">
													<?PHP if (isset($_SESSION['l']) && isset($_SESSION['p'])) 
{  ?> 
													<input type="hidden" name="idc" value="<?PHP echo $_SESSION['id'] ?>">
													<input type="hidden" name="nom" value="<?PHP echo $_SESSION['l'] ?>">
													<?PHP } ?>
													...
													<center><button type="submit" class="btn btn-primary btn-space m-t-5" value="modifier" name="modifier">Ajouter au panier <i class="fa fa-shopping-cart"></i></button></center>	
														...
														<form class="form-horizontal" name="formR" method="POST" action="contact.php?idproduit=<?PHP echo $row['idproduit'] ?>" onclick="return confirmation();">
															<input type="hidden" name="nomproduit" value="<?PHP echo $row['idproduit'] ?>">
															<center><button type="submit" class="btn btn-primary btn-space m-t-5" value="modifier" name="modifier">Ajouter au Reclamation <i class="fa fa-question-circle"></i></button></center>
														</form>
