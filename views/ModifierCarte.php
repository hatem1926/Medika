      ...
      <div class="main-wrapper">
        ...
        <aside class="app-sidebar">
          ...
          <ul class="side-menu">
            ...
            <li class="slide">
              <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fa fa-table"></i><span class="side-menu__label">Gestion Client</span><span class="badge badge-secondary nav-badge1">New</span></a>
