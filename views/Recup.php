...
<!--<img src="ars.jpg" alt="HTML5 Icon" style="">-->  
  ...
  <!-- End menu -->
   ...
   <div class="form">
        <h3 class="titre">Récuperation du mot de passe</h3>
    <form  method="POST" name="f"  >
      <p>Ecrire votre adresse email</p>
      <input type="email" name="recup_mail" id="mail" placeholder="Entrer votre adresse email" >
