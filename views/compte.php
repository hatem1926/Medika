     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           ...
           <h2 style="color: ; font-size: 50px" >Voici vos Données</h2>
           <ol class="breadcrumb">
...
<div class="card-body">
                    ...
                    <tr><th><b>Nom d'utilisateur</b></th><td><?PHP echo $row['username']; ?></td></tr>
                    <tr><th><b>E-mail</b></th><td><?PHP echo $mail; ?></td></tr>
                    <tr><th><b>Numero de téléphone</b></th><td><?PHP echo $tel; ?></td></tr>
                    <tr><th><b>Date de naissance</b></th><td><?PHP echo $age; ?></td></tr>
                    <tr><th><b>Nom</b></th><td><?PHP echo $nom; ?></td></tr>
                    <tr><th><b>Prenom</b></th><td><?PHP echo $prenom; ?></td></tr>
...
?>
                 <br/><br/>
                  <a href="modifierclient.php?username=<?PHP echo $row['username']; ?>"><button class="mu-subscribe-btn" type="submit" value="modifier" style="background-color: gold; width: 200px; height: 50px; box-shadow: 3px 3px 3px; border-radius: 10px" > Modifier </button></a>

                  <form method="POST" action="ajoutdemande.php">
                    <table><tr><td><input hidden type="text" name="demande" value="<?php echo $username ?>" readonly></td></tr></table>
                    <button class="mu-subscribe-btn" type="submit" value="" style="background-color: gold; width: 200px; height: 50px; box-shadow: 3px 3px 3px; border-radius: 10px" > Lancer demande </button>
                  </form>
